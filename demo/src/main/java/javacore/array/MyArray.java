...
public class MyArray {
    ...
    private String[] array; //自定义数组底层构建数组。= new String[DEFAULT_CAPACITY]，先不初始化，在构造的时候再初始化
    ...
    public MyArray() {  //构造方法的是目的是创建对象
        ...
        array = new String[DEFAULT_CAPACITY]; //无参默认创建的数组长度为10
    }
    ...
    public String remove(int index) {
        rangeCheck(index);
        String removeObj = array[index]; //即将要删除的元素
