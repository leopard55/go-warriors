...
public class TestCRUDByXmlMapper {
    ...
    public void testAdd(){
        ...
        /**
         * 映射sql的标识字符串，
         * com.leopard.mapping.userMapper是userMapper.xml文件中mapper标签的namespace属性的值，
    ...
    public void testUpdate(){
         ...
         */
        String statement = "com.leopard.mapping.userMapper.updateUser";//映射sql的标识字符串
        User user = new User();
        user.setId(3);
        user.setName("孤傲苍狼");
        user.setAge(25);
    ...
    public void testDelete(){
         ...
         */
        String statement = "com.leopard.mapping.userMapper.deleteUser";//映射sql的标识字符串
        //执行删除操作
    ...
    public void testGetAll(){
         ...
         */
        String statement = "com.leopard.mapping.userMapper.getAllUsers";//映射sql的标识字符串
